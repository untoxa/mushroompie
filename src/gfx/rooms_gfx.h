...
// room 2_0 handlers
void init_room2_0(); void move_spider(); void draw_spider();
...
// room 1_1 handlers
void reset_room1();
void init_room1_1(); void draw_flames1_1();
...
const room_t const room_2_0 = {3, &room_2_0_map, &room_2_0_coll, &room_2_0_tiles, &enemies_2_0_tiles,  &init_room2_0, &move_spider,   &draw_spider,    0,               0,               &coll_spider, 0,                      0,              0};
...
const room_t const room_1_1 = {4, &room_1_1_map, &room_1_1_coll, &room_1_1_tiles, &enemies_1_1_tiles,  &init_room1_1, 0,              &draw_flames1_1, &hcoll_blockage, &vcoll_blockage, 0,            &cleaning_path,         &reset_room1,   0};
...
extern tile_data_t enemies_2_0_tiles;
...
extern tile_data_t enemies_1_1_tiles;
