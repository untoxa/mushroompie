...
// items
const tile_data_t const null_mask = {4, {
0x00, 
0x00, 
0x00, 
0x00
...
const tile_data_t const coin_mask = {4, {
0x03, 0xF8,0xE0,0xC0,0x80,0x80,0x00,0x00,0x00,
0x03, 0x0F,0x03,0x01,0x00,0x00,0x00,0x00,0x00,
0x03, 0x00,0x00,0x00,0x00,0x80,0x80,0xC0,0xE0,
0x03, 0x00,0x00,0x00,0x00,0x00,0x00,0x01,0x03
}};
...
const tile_data_t const pickaxe_mask = {4, {
0x03, 0x07,0x03,0x03,0x01,0x00,0x80,0xE0,0xF0,
0x03, 0xFF,0xFF,0xFC,0xFC,0xFC,0x78,0x38,0x10,
0x03, 0xF8,0xFC,0xFE,0xFF,0xFF,0xF8,0x80,0x00,
0x00
}};
...
const tile_data_t const key_mask = {4, {
0x00,
0x03, 0x7F,0x3F,0x3F,0x3F,0x3F,0x1F,0x0F,0x07,
0x03, 0x80,0xFE,0xFE,0xFC,0xFC,0xFC,0xFE,0xFF,
0x03, 0x03,0x01,0x00,0x00,0x00,0x00,0x00,0x07,
}};
...
const tile_data_t const mushrooms_mask = {4, {
0x03, 0xC0,0x80,0x00,0x00,0x00,0xC0,0x80,0x00,
0x03, 0x41,0x01,0x01,0x01,0x0F,0x01,0x01,0x01,
0x03, 0x00,0x00,0x00,0x80,0x80,0x80,0x80,0xE0,
...
const tile_data_t const grass_mask = {4, {
0x03, 0xE0,0xE0,0xC0,0xC0,0xC2,0x02,0x00,0x00,
0x03, 0x30,0x30,0x30,0x30,0x31,0x00,0x00,0x08,
0x03, 0x04,0x04,0x00,0x00,0x60,0x00,0x00,0x00,
0x00
}};
...
const tile_data_t const pie_mask = {4, {
0x03, 0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00,
0x03, 0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x00,0x00,
...
const tile_data_t const jar_mask = {4, {
0x03, 0xE0,0xC0,0xC0,0x80,0x80,0x00,0x00,0x00,
0x03, 0x07,0x03,0x03,0x01,0x01,0x00,0x00,0x00,
0x03, 0x00,0x00,0x00,0x00,0x00,0x00,0x80,0xE0,
...
const tile_data_t const lid_mask = {4, {
0x03, 0xFF,0xF8,0xE0,0xC0,0x80,0x80,0x80,0x80,
0x03, 0xFF,0x1F,0x07,0x03,0x03,0x01,0x01,0x01,
0x03, 0x80,0x80,0x80,0x80,0x80,0xC0,0xE0,0xF8,
0x03, 0x01,0x01,0x01,0x01,0x01,0x03,0x07,0x1F,
}};
// title, inventory frame and font and other

const unsigned char const title_map[] = {
0xEE,0xEF,0xEF,0xF0,0xF0,0xF1,0xF2,0xF1,0xEF,0xF2,0xEF,0xF0,0xF1,0xF2,0xF1,0xF2,
0xF0,0xEF,0xF0,0xF3,0xF4,0xF5,0xF5,0xF6,0xF6,0xF7,0xF8,0xF7,0xF5,0xF8,0xF5,0xF6,
0xF7,0xF8,0xF7,0xF8,0xF6,0xF5,0xF6,0xF9,0xFA,0xFB,0xFB,0xFC,0xFC,0xFD,0xFE,0xFD,
0xFB,0xFE,0xFB,0xFC,0xFD,0xFE,0xFD,0xFE,0xFC,0xFB,0xFC,0xFF 
};
