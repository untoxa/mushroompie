...
%GBDK%\bin\link-gbz80.exe -n -- -z -m -j -yt1 -yo8 -k%GBDKLIB%\gbz80\ -lgbz80.lib -k%GBDKLIB%\gb\ -lgb.lib mushroompie.gb %GBDKLIB%\gb\crt0.o build\sdcc4_stub.rel build\00_title_gfx_data.rel %OBJ%\00_dialogs_data.rel build\01_anim_gfx_data.rel build\02_rooms_gfx_data0.rel build\02_rooms_gfx_data1_0.rel build\02_rooms_gfx_data1_1.rel build\mushroompie.rel
